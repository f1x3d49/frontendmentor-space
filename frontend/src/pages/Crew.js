...
const Crew = () => {
  return (
    <section className="bg-fixed bg-no-repeat bg-cover bg-bgCrewMobile tb:bg-bgCrewTablet dt:bg-bgCrewDesktop w-full h-screen">
      <div className="w-full h-full flex flex-col justify-start items-center gap-[32px] pt-[89px] tb:pt-[136px] dt:pt-[212px]">
        ...
        <div className="flex flex-col dt:flex-row items-center justify-center dt:justify-between dt:w-full gap-[32px] ">
          ...
          <div className="w-[327px] flex items-center justify-center border-b-[1px] border-[#383B4B] tb:border-0">
            <img src={douglas} alt="astronaut" className="w-1/2" />
          </div>
          {/* Circle Tab */}
          <CircleTabComponent />
        </div>
