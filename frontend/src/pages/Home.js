...
const Home = () => {
  return (
    <section className="bg-fixed bg-no-repeat bg-cover bg-bgHomeMobile tb:bg-bgHomeTablet dt:bg-bgHomeDesktop text-white w-full h-screen pt-8">
      <div className="flex flex-col dt:flex-row justify-start dt:justify-center items-center w-full h-full gap-[64px] tb:gap-[120px] dt:gap-0">
        {/* Text Container */}
        <div className="mt-[112px] tb:mt-[202px] px-[24px] tb:px-[159px] dt:pl-[165px] dt:pr-0 w-full flex flex-col items-center justify-center gap-[16px] dt:gap-[24px]">
          ...
          <p className="text-primary2 text-center dt:text-left text-[15px] tb:text-[16px] dt:text-[18px] font-barlow leading-[25px] tb:leading-[28px] dt:leading-[32px]">
        ...
        {/* Button Container */}
        <button className="flex items-center justify-center w-[150px] tb:w-[242px] dt:w-[274px] h-[150px] tb:h-[242px] dt:h-[274px] bg-primary3 rounded-full">
